# lib/test_payment_proof_fixed.rb
require File.expand_path('../../config/environment', __FILE__)

puts "Testing Payment Proof Submission (Fixed)..."
puts "=" * 50
...
begin
  ...
  puts "Please add 'awaiting_verification' to your payment_status enum"
  puts "Current values: #{Order.payment_statuses.inspect}"
end